...
export default function GlobePulse({
  ...
  dark: 0,                   // 0 enables light mode shading (was 1)
  diffuse: 1.2,              // Slightly softened for a white surface
  mapSamples: 16000,
  mapBrightness: 6,          // Lowered so dots don't blow out against white (was 10)
  baseColor: [1, 1, 1],      // Pure white [R, G, B]
  glowColor: [0.95, 0.95, 0.95], // Very light grey/white ambient glow (was dark grey)
  // --------------------------------
  
  markerColor: [0.2, 0.8, 0.9], // Kept your original cyan for high contrast
  markerElevation: 0,
  ...
  arcWidth: 0.5,
  arcHeight: 0.25,
  opacity: 0.8,              // Slightly increased opacity to make the white pop
})
